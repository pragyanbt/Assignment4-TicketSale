...
describe("TicketSale", () => {
    ...
    it("buys a ticket", async () => {
        await ticketSale.methods.buyTicket(1).send({
            from: accounts[1],
            value: web3.utils.toWei('0.0001', 'ether'), // Adjusting according to the ticket price
            gas: '3000000'
        });
    ...
    it("accepts resale", async () => {
        ...
        await ticketSale.methods.resaleTicket(web3.utils.toWei('0.0001', 'ether')).send({ from: accounts[1] });
